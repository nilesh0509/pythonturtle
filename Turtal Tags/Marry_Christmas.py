...
#print("Yesterday is history, tomorrow is a mystery, but today is a gift. That is why it is called the present.”)
oogway = Turtle()
# set turtle speed
oogway.speed(2)
...
oogway.speed(1)
oogway.penup()
msg = "It’s people like you that make Christmas so special and meaningful. Thank you!"
